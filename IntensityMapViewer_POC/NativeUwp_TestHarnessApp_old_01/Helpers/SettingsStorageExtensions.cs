...
namespace NativeUwp_TestHarnessApp.Helpers
{
    ...
    public static class SettingsStorageExtensions
    {
        ...
        public static async Task SaveAsync<T>(this StorageFolder folder, string name, T content)
        {
            ...
            var fileContent = await Common.Json.StringifyAsync(content);
        ...
        public static async Task<T> ReadAsync<T>(this StorageFolder folder, string name)
        {
            ...
            return await Common.Json.ToObjectAsync<T>(fileContent);
        }

        public static async Task SaveAsync<T>(this ApplicationDataContainer settings, string key, T value)
        {
            settings.SaveString(key, await Common.Json.StringifyAsync(value));
        }
        ...
        public static async Task<T> ReadAsync<T>(this ApplicationDataContainer settings, string key)
        {
            ...
            {
                return await Common.Json.ToObjectAsync<T>((string)obj);
            }
